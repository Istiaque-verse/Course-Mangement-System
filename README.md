...
A role‑based Course Management System built with Java Servlets, JSP, JSTL, Bootstrap, and MySQL. It provides separate portals for Admin, Teacher, and Student with a clean, modern UI and clear separation of concerns (MVC style). [web:538]
...
You can now create `README.md` in the project root, paste this content, tweak any names (WAR name, DB name, default users), then commit and push:
